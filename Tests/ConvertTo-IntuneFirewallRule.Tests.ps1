...
. "$($PathToScript)\..\Intune-FWRules-Migration\Public\ConvertTo-IntuneFirewallRule.ps1"
. "$($PathToScript)\..\Intune-FWRules-Migration\Private\ConvertTo-IntuneFirewallRule-Helper.ps1"
